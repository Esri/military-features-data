...
SET SQLITE_PATH_AND_EXE={TODO_EDIT_THIS_PATH}\sqlite3.exe
:: EXAMPLE: SET SQLITE_PATH_AND_EXE=C:\Installs\Sqlite\sqlite3.exe

:: (2) SQLITE DATABASE to run script against
SET SQLITE_DATABASE={TODO_EDIT_THIS_PATH/DB}\MYSQLITE.db

:: (3) SQL Script to Run against database
SET SQLITE_SCRIPT={TODO_EDIT_THIS_PATH/SCRIPT}\SQLITE_SCRIPT.sql
